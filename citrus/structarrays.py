...
def init_config_params():
    fields = np.dtype(
        [
            ...
            ("min_scale_squ", "f8"),
            ("taylor_cutoff", "f8"),
            ("grid_density_global_max", "f8"),
            ("ncell", "i8"),
            ("n_images", "i8"),
            ("n_species", "i8"),
            ("num_densities", "i8"),
            ("do_pregrid", "i8"),
            ("num_grid_density_maxima", "i8"),
            ("num_dims", "i8"),
            ("n_line_images", "i8"),
            ("n_cont_images", "i8"),
            ("data_flags", "i8"),
            ("n_solve_iters_done", "i8"),
            ("do_interpolate_vels", "bool"),
            ("use_abun", "bool"),
            ("do_mol_calcs", "bool"),
            ("write_grid_at_stage", "bool", NUM_OF_GRID_STAGES),
            ("use_vel_func_in_raytrace", "bool"),
            ("edge_vels_available", "bool"),
        ],
        align=True,
    )
